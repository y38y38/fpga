...
proc create_root_design { parentCell } {
  ...
  # Create instance: myip4_v1_0_0, and set properties
  set block_name myip4_v1_0
  set block_cell_name myip4_v1_0_0
  if { [catch {set myip4_v1_0_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $myip4_v1_0_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins myip4_v1_0_0/s00_axi] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs myip4_v1_0_0/s00_axi/reg0] -force
