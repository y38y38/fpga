...
proc create_root_design { parentCell } {
  ...
  # Create instance: test_output_0, and set properties
  set block_name test_output
  set block_cell_name test_output_0
  if { [catch {set test_output_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $test_output_0 eq "" } {
