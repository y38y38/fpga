...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_net [get_bd_pins myip_0/m00_axi_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]

	# Connect all clock & reset of myip_0 streaming interfaces..
	connect_bd_net [get_bd_pins myip_0/s00_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins myip_0/s00_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set_property -dict [list  CONFIG.C_M00_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells myip_0]
