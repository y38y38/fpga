	...
	//Check received read data against data generator                       
	  ...
	  begin                                                                 
	    if (M_AXI_ARESETN == 0 || init_txn_pulse == 1'b1)                   
	      begin                                                             
	        read_mismatch <= 1'b0;
			dma_read_data <= 32'h8c8c8c8c;
			dma_read_addr <= 32'h00000000c;                                          
	      end                                                               
...
//	                mst_exec_state  <= INIT_WRITE;                                                              
	...
	// Add user logic here
	assign DMA_READ_DATA = dma_read_data;
	assign DMA_READ_ADDR = dma_read_addr;
	// User logic ends
