...
module design_1
  ...
  wire [3:0]pattern_0_VGA_B;
  wire [3:0]pattern_0_VGA_G;
  wire pattern_0_VGA_HS;
  wire [3:0]pattern_0_VGA_R;
  wire pattern_0_VGA_VS;
  wire zynq_ultra_ps_e_0_pl_clk0;
  wire zynq_ultra_ps_e_0_pl_clk1;
  wire zynq_ultra_ps_e_0_pl_resetn0;

  assign VGA_B_0[3:0] = pattern_0_VGA_B;
  assign VGA_G_0[3:0] = pattern_0_VGA_G;
  assign VGA_HS_0 = pattern_0_VGA_HS;
  assign VGA_R_0[3:0] = pattern_0_VGA_R;
  assign VGA_VS_0 = pattern_0_VGA_VS;
  design_1_pattern_0_0 pattern_0
       (.CLK(zynq_ultra_ps_e_0_pl_clk1),
        .RST(zynq_ultra_ps_e_0_pl_resetn0),
        .VGA_B(pattern_0_VGA_B),
        .VGA_G(pattern_0_VGA_G),
        .VGA_HS(pattern_0_VGA_HS),
        .VGA_R(pattern_0_VGA_R),
        .VGA_VS(pattern_0_VGA_VS));
