...
loadhw -hw C:/v/d4/w/hw/system.hdf -mem-ranges [list {0x80000000 0xbfffffff} {0x400000000 0x5ffffffff} {0x1000000000 0x7fffffffff}]
configparams force-mem-access 1
targets -set -nocase -filter {name =~"APU*" && jtag_cable_name =~ "Avnet USB-to-JTAG/UART Pod V1 1234-oj1A"} -index 1
source C:/v/d4/w/hw/psu_init.tcl
psu_init
after 1000
...
rst -processor
dow C:/v/d4/w/standalone_bsp_0_xdpdma_video_example_1/Debug/standalone_bsp_0_xdpdma_video_example_1.elf
